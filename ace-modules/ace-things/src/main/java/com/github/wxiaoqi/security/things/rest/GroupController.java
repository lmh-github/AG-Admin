...
import com.github.wxiaoqi.security.things.biz.ResourceAuthorityBiz;
...
import com.github.wxiaoqi.security.things.biz.GroupBiz;
import com.github.wxiaoqi.security.things.entity.Group;
import com.github.wxiaoqi.security.things.vo.GroupTree;
...
public class GroupController extends BaseController<GroupBiz, Group> {
    ...
    public List<GroupTree> tree(String name,String groupType) {
        ...
        return  getTree(baseBiz.selectByExample(example), ThingsCommonConstant.ROOT);
    }
