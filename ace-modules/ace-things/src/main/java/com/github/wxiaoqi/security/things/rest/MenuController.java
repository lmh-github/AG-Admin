...
public class MenuController extends BaseController<MenuBiz, Menu> {
    ...
    public List<MenuTree> getTree(String title) {
        ...
        return getMenuTree(baseBiz.selectByExample(example), ThingsCommonConstant.ROOT);
    }
    ...
    public List<Menu> getSystem() {
        Menu menu = new Menu();
        menu.setParentId(ThingsCommonConstant.ROOT);
    ...
    public List<AuthorityMenuTree> listAuthorityMenu() {
        ...
        return TreeUtil.bulid(trees, ThingsCommonConstant.ROOT);
    }
