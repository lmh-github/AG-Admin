...
import com.github.wxiaoqi.security.things.entity.Menu;
import com.github.wxiaoqi.security.things.entity.ResourceAuthority;
import com.github.wxiaoqi.security.things.mapper.GroupMapper;
import com.github.wxiaoqi.security.things.mapper.MenuMapper;
import com.github.wxiaoqi.security.things.mapper.ResourceAuthorityMapper;
import com.github.wxiaoqi.security.things.mapper.UserMapper;
import com.github.wxiaoqi.security.things.vo.AuthorityMenuTree;
import com.github.wxiaoqi.security.things.vo.GroupUsers;
...
public class GroupBiz extends BaseBiz<GroupMapper, Group> {
    ...
    public void insertSelective(Group entity) {
        if (ThingsCommonConstant.ROOT == entity.getParentId()) {
    ...
    public void modifyAuthorityMenu(int groupId, String[] menus) {
        resourceAuthorityMapper.deleteByAuthorityIdAndResourceType(groupId + "", ThingsCommonConstant.RESOURCE_TYPE_MENU);
        ...
        for (String menuId : relationMenus) {
            authority = new ResourceAuthority(ThingsCommonConstant.AUTHORITY_TYPE_GROUP, ThingsCommonConstant.RESOURCE_TYPE_MENU);
    ...
    private void findParentID(Map<String, String> map, Set<String> relationMenus, String id) {
        ...
        if (String.valueOf(ThingsCommonConstant.ROOT).equals(id)) {
            return;
        }
    ...
    public void modifyAuthorityElement(int groupId, int menuId, int elementId) {
        ResourceAuthority authority = new ResourceAuthority(ThingsCommonConstant.AUTHORITY_TYPE_GROUP, ThingsCommonConstant.RESOURCE_TYPE_BTN);
        authority.setAuthorityId(groupId + "");
    ...
    public List<AuthorityMenuTree> getAuthorityMenu(int groupId) {
        List<Menu> menus = menuMapper.selectMenuByAuthorityId(String.valueOf(groupId), ThingsCommonConstant.AUTHORITY_TYPE_GROUP);
